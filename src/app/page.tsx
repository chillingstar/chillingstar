                ...
                <Card className='max-w-[780px] min-w-[780px]'>
                    ...
                    <CardFooter>
                        <div className="flex flex-col justify-center items-center w-full space-y-2">
                            ...
                            <p>Deployed by <span className='inline-flex items-center'><Image src={svgUrl(siVercel)} alt={siVercel.title} radius='none' width={16} height={16} className={getIconClass(theme)} /><span className='ml-1'>Vercel</span></span> & <span className='inline-flex items-center'><Image src={svgUrl(siCloudflarepages)} alt={siCloudflarepages.title} radius='none' width={16} height={16} className={getIconClass(theme)} /><span className='ml-1'>Cloudflare Pages</span></span></p>
                        </div>
                    </CardFooter>
                </Card>
            </div>
